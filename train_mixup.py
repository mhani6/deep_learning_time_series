...
def main(args):
    ...
    if args.model in ("patchtst", "both", "all"):
        ...
        history, best_acc = train(
            ...
            model_name="patchtst", n_classes=n_classes,
            epochs=args.epochs,
            lr=args.lr,
        ...
        results["patchtst"] = evaluate(model, test_loader, device, le,
                                        model_name="patchtst", n_classes=n_classes, save_dir="runs")
    ...
    if args.model in ("units", "all"):
        ...
        history, best_acc = train(
            ...
            model_name="units", n_classes=n_classes,
            epochs=args.epochs,
            lr=args.lr,
            patience=args.patience,
            save_dir="runs",
        ...
        results["units"] = evaluate(units, test_loader, device, le,
                                     model_name="units", n_classes=n_classes, save_dir="runs")
    ...
    if args.model in ("baseline", "both", "all"):
        ...
        history, best_acc = train(
            ...
            model_name="baseline", n_classes=n_classes,
            epochs=args.epochs,
            lr=args.lr,
            patience=args.patience,
            save_dir="runs",
        ...
        results["baseline"] = evaluate(baseline, test_loader, device, le,
                                         model_name="baseline", n_classes=n_classes, save_dir="runs")
